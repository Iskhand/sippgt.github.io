...
<h3 class="mt-1 text-center">Data Blok 2</h3>
...
<!-- /.card-header -->
	<div class="card-body bg-white">
		<div class="table-responsive">
			...
			//   }
			  $tanggal = date('Y-m-d');
			  $sql = $koneksi->query("SELECT * from tb_pegawai where kategori='BLOK_2'");
            ...
            ?>
					...
					<tr class="text-center">
						...
						<td>
							<?php $lin = $koneksi->query("SELECT * FROM tb_blok2 where (nip IS NULL OR nip ='".$data['nip']."') and (tanggal IS NULL OR tanggal ='".$tanggal."')");
