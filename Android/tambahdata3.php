<?php
	...
	if(empty($id_linting)) {
		$query = mysqli_query($con,"INSERT INTO tb_blok3(`id_linting`,`nip`, `nama_pegawai`, `lt_merah`, `lt_cokelat`,`lt_hitam`,`lt_jawas`, `jumlah`, `paten`, `tanggal`) VALUES(NULL,'".$nip."','".$nama_pegawai."','".$lt_merah."','".$lt_cokelat."','".$lt_hitam."','".$lt_jawas."','".$jumlah."','".$paten."', '".$tanggal."');");
